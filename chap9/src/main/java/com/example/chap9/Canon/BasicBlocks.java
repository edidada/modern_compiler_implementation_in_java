...
public class BasicBlocks {
  ...
  public com.example.chap6.Temp.Label done;
  ...
  void mkBlocks(com.example.chap7.Tree.StmList l) {
	...
	doStms(l.tail);
     ...
     else mkBlocks(new com.example.chap7.Tree.StmList(new com.example.chap7.Tree.LABEL(new com.example.chap6.Temp.Label()), l));
  }
   

  public BasicBlocks(com.example.chap7.Tree.StmList stms) {
    done = new com.example.chap6.Temp.Label();
    mkBlocks(stms);
  }
}
