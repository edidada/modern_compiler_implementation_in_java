package com.example.chap10.Graph;
...
public class Graph {
  ...
  void check(Node n) {
      if (n.mygraph != this)
	throw new Error("com.example.chap10.Graph.addEdge using nodes from the wrong graph");
  }
  ...
  NodeList delete(Node a, NodeList l) {
	if (l==null) throw new Error("com.example.chap10.Graph.rmEdge: edge nonexistent");
